...
graph insert_random.csv -x "Param: size" -y "Score" -l "insert_random" --xlabel "Number of operation" --ylabel "Milliseconds" --fontsize 14 --marker " " --figsize 1600x1000 -l "insert_random" --chain | graph insert_sorted.csv -x "Param: size" -y "Score" --marker " " -l "insert_sorted" --chain | graph insert_to_size.csv -x "Param: size" -y "Score" --marker " " -l "insert_to_size" --chain | graph delete.csv -x "Param: size" -y "Score" --marker " " -l "delete" --chain | graph search.csv -x "Param: size" -y "Score" --marker " " -l "search" --title "Splay" -o sample.png
